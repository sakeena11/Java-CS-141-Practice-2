...
public class BasicTypes {
    public static void main(String[] args) {
        ...
        String name = keyScan.nextLine(); //set
        ...
        System.out.println("Ok," + name + " this year you are " + age + " years old.");


        //ask the user for their height (in feet and inches)
        //then calculate and print their height in just inches and in meters
        System.out.println("How tall are you " + name + " ? Please enter in feet and inches.");
        ...
        System.out.println(name + ", you are " +heightTotalInches + " inches tall.");
        ...
        System.out.println("Wow! Thanks for all that personal info " + name + "! You deserve some free donuts!");
